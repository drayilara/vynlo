...
const DISCORD_LINK = "https://discord.gg/INVITE_CODE";
      ...
      <nav className="fixed top-0 w-full z-50 bg-neutral-950/70 backdrop-blur-xl bg-neutral-900/50">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <a
            ...
            className="bg-[#00FF85] text-[#003919] px-5 py-2.5 rounded-lg text-sm font-bold scale-95 active:scale-90 transition-transform hover:opacity-90"
          >
            Join the Community
          </a>
        </div>
