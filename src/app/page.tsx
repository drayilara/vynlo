      ...
      <nav className="fixed top-0 w-full z-50 bg-neutral-950/70 backdrop-blur-xl bg-neutral-900/50">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          >
            ...
            <span className="text-[8px] md:text-[10px] text-neutral-300 font-body tracking-wide md:border-l md:border-neutral-700 md:pl-3">
              PROFESSIONAL ADS, MINUS THE EFFORT.
            </span>
          </a>
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-3">
                ...
                <p className="text-neutral-500 font-body">
                  Get Access the elite performance marketers using Vynlo.
                </p>
              </div>
